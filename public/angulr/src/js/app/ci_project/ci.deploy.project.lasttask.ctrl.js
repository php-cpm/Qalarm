app.controller("DeployProjectLastTaskCtrl", ['$state', '$scope', '$modal', 'NgTableParams', 'ciProjectModel', '$timeout','toaster','commonModel', '$stateParams',
    function ($state, $scope, $modal, NgTableParams, ciProjectModel, $timeout, toaster, commonModel, $stateParams) {
        ...
        self.deploy_step_id  = $stateParams.deploy_step_id;
        ...
        function getNgTableData(pageParams){
            ...
            var urlParams = {'deploy_id' : 0, 'deploy_step_id' : self.deploy_step_id};
