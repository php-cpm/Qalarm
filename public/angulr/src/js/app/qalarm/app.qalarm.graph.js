...
app.controller("QalarmGraph", ['$scope', '$state', '$rootScope', '$modal', '$http', '$timeout', 'NgTableParams', 'toaster', 'QalarmModel', '$confirm',
    function ($scope, $state, $rootScope, $modal, $http, $timeout, NgTableParams, toaster, QalarmModel, $confirm) {
            ...
            if (data != null) {
                $.each(data, function(pname, detail) {
                    ...
                    if (undefined === projectIdxs[pname]){
                        ...
                        if (projects[projectIdxs[pname]['id']] != undefined) {
                            //add data
        ...
        $scope.onLoad = function () {
            errChart = this;
            QalarmModel.getGraphs().get({}, {}).$promise.then(function (response) {
