    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                ...
                fileNamePrefix = ''+year + month + day + nowDate.getHours() + nowDate.getMinutes() +nowDate.getSeconds();

                file.file.name = fileNamePrefix + '_' + file.file.name;
                ...
                $.ajax({
                    dataType:'text',
                    async:false,
                    url:"../../php/Qiniu_gettoken.php?key="+filename,
