...
class SmtpEmailUtil
{
    ...
    static function send($to, $title, $msg, $debug = false)
    {
        $from = 'gaea@ttyongche.com';
        $password = 'ttyc_2015';

        $smtpserver = "smtp.ttyongche.com";      //SMTP服务器
        ...
        $mailcontent = "<h1>".$msg."</h1>";      //邮件内容
        $mailtype = "HTML";                      //邮件格式（HTML/TXT）,TXT为文本邮件
        //************************ 配置信息 ****************************
        $smtp = new SmtpEmailUtil($smtpserver,$smtpserverport,true,$smtpuser,$smtppass);//这里面的一个true是表示使用身份验证,否则不使用身份验证.
